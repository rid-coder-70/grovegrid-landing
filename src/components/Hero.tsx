...
export const Hero = () => {
  return (
    <header className="relative min-h-screen flex flex-col items-center justify-center pt-24 pb-12 overflow-hidden z-10 px-6 text-center">
      ...
      >
        <div className="inline-block border border-borderCol bg-panel px-4 py-1.5 mb-8 font-mono text-xs text-textMuted uppercase tracking-widest">
          v1.0 — Launch Day, May 10 2026
        </div>

        <h1 className="font-syne font-extrabold text-5xl md:text-7xl lg:text-8xl tracking-tightest leading-[1.1] mb-6 text-textMain">
          We Build the Web.<br />
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-16 w-full sm:w-auto">
          <a
            href="#contact"
            className="px-8 py-4 bg-cyan-default text-bg font-mono font-bold uppercase tracking-widest hover:bg-white transition-colors flex items-center justify-center gap-2"
          >
            Launch Your Project <span>&rarr;</span>
          </a>
          <a
            href="#services"
            className="px-8 py-4 border border-borderCol bg-panel text-textMain font-mono uppercase tracking-widest hover:border-cyan-default hover:text-cyan-default transition-colors"
          >
            Explore Services
          </a>
        </div>
